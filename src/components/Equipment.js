...
class Equipment extends Component {
  render() {
    return (
		...
		<h3>Harness</h3>
		<img className="alignright" src="/emptyharness.jpeg" alt="A rock climbing harness" />
		...
		<h3>Shoes</h3>
		<img className="alignright" src="/shoes.jpeg" alt="A rock climbing shoe" />
		...
		<h3>Belay Device</h3>
		<img className="alignright" src="/atc-xp.jpeg" alt="An ATC-style belay device" />
		...
		<img className="alignright" src="/chalk-carabiner.jpeg" alt="A chalk bag and a carabiner" />
		...
		<h3>Helmet</h3>
		<img className="alignright" src="/helmet.jpeg" alt="A climbing helmet" />
